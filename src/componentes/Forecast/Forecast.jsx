...
const renderForecastItem = forecast => {
    ...
    //se agrega marca como identificador único para findByTestId
    return (
...
//forecastItemList es un array de elementos, que debe tener una "forma" (hour,state,temperature,weekDay)
Forecast.propTypes = {
